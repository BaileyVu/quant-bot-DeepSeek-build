...
Edit `config/config.yaml` to change symbols, timeframes, capital, fee/slippage assumptions, or paper trading parameters. Default values are suitable for the MVP.
...
## 🤝 Contributing
This project is frozen per the specifications in `docs/`. If you wish to extend it, please read the documentation first and respect the design decisions.
